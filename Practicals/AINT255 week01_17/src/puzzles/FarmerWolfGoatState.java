...
public class FarmerWolfGoatState extends AbstractState {
    ...
    private final void addIfSafe(Set<AbstractState> moves) {
     ...
     * solve this problem from this state. This is implemented as the number of
     * characters on the east side.
     */
