...
public class SlidingTileState extends AbstractState {
    ...
    /**
     * Constructs a new default sliding tile state. This is specified as the
     * game start state: B B B W W W
     */
     ...
     * @param tile the location of the tile to move into the space
     */
    ...
    /**
     * The solution is specified as having all the white tiles to the left of
     * all the black tiles.
     *
     ...
     * solve this problem from this state. This is implemented as counting the
     * number of white tiles to the right of black tiles.
     */
